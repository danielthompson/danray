...
public class BuildTests {
   ...
   public void testBuildNodeWithOneSphere() throws Exception {
      ...
      for (int i = 0; i < 1; i++) {
         sphere = new Sphere();
         sphere.Origin = new Point3((float)Math.random() * 100, (float)Math.random() * 100, (float)Math.random() * 100);
         sphere.Radius = 1;
      ...
      Assert.assertNull(rootNode.LeftChild);
      Assert.assertNull(rootNode.RightChild);
   }
   ...
   public void testBuildNodeWithFiveSpheres() throws Exception {
      ...
      Assert.assertNotNull(rootNode.LeftChild, "left child should not be null with 5 elements");
      Assert.assertNotNull(rootNode.RightChild, "right child should not be null with 5 elements");
   }
   ...
   public void testBuildNodeWithFiftySpheres() throws Exception {
      ...
      Assert.assertNotNull(rootNode.LeftChild, "left child should not be null with 50 elements");
      Assert.assertNotNull(rootNode.RightChild, "right child should not be null with 50 elements");
   }
   ...
   public void testBuildNodeWith500Spheres() throws Exception {
      ...
      Assert.assertNotNull(rootNode.LeftChild, "left child should not be null with 500 elements");
      Assert.assertNotNull(rootNode.RightChild, "right child should not be null with 500 elements");
   }
   ...
   public void testBuildNodeWith5000Spheres() throws Exception {
      ...
      Assert.assertNotNull(rootNode.LeftChild, "left child should not be null with 5000 elements");
      Assert.assertNotNull(rootNode.RightChild, "right child should not be null with 5000 elements");
